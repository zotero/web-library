...
<style xmlns="http://purl.org/net/xbiblio/csl" class="note" demote-non-dropping-particle="display-and-sort" page-range-format="chicago-16" version="1.0">
  ...
  <info>
    <title>Chicago Manual of Style 17th edition (notes and bibliography, subsequent author-title)</title>
    <title-short>CMOS 17e with Bluebook (notes and bibliography [14.19], subsequent author-title [14.34])</title-short>
    <id>http://www.zotero.org/styles/chicago-notes-bibliography-subsequent-author-title-17th-edition</id>
    <link href="http://www.zotero.org/styles/chicago-notes-bibliography-subsequent-author-title-17th-edition" rel="self"/>
    ...
    <summary>Chicago-style source citations (with Bluebook for legal citations), notes and bibliography system, 17th edition, with author-title subsequent shortened citations (CMOS17 14.34)</summary>
    <updated>2025-08-25T17:26:51+00:00</updated>
  ...
  <macro name="author-note">
    <names variable="composer">
      <name and="text" delimiter-precedes-last="contextual"/>
      <label form="short" prefix=", "/>
      <substitute>
        <names variable="author"/>
        ...
        <names variable="illustrator"/>
        <choose>
          <!-- In multivolume works, notes list editors after the title of the part for which they are responsible (CMOS18 14.20-24); it appears also that editors should not be substituted for authors with chapters (cf. CMOS18 14.22) -->
        ...
        <names variable="curator"/>
        <!-- \`software\` does not substitute publisher name in notes (CMOS18 14.169) -->
        <choose>
          <!-- notes substitute \`container-title\` in a narrower set of circumstances than bibliography -->
      ...
      <group delimiter=" ">
        <group delimiter=", ">
          <choose>
            <if type="broadcast" variable="container-title number title">
              <!-- Bespoke \`broadcast\` format (CMOS18 14.165, 14.168) -->
              <text macro="source-monographic-title-note"/>
              <group delimiter=", ">
                <text macro="identifier-number-note"/>
                <text macro="title-note"/>
                <text macro="description-note"/>
    ...
    <group delimiter=", ">
      <choose>
        ...
        <else>
          ...
          <choose>
            <if match="any" variable="part-title volume-title">
              <!-- if there is a volume or part title, contributors follow the corresponding titles: parent title first in notes (CMOS18 14.20) -->
              <names variable="collection-editor">
  ...
  <macro name="source-serial-identifier-volume-bib">
    <group delimiter=", ">
      <choose>
        ...
        <else>
          <text variable="collection-title"/>
          <!-- publisher possible with \`interview\` (CMOS18 14.110) -->
          <text variable="publisher"/>
          <text macro="source-serial-volume-status-bib"/>
        </else>
      </choose>
      ...
      <choose>
        <if variable="container-title">
          <group delimiter=", ">
            ...
            <text macro="source-monographic-description-note"/>
  ...
  <macro name="source-monographic-title-note">
    <text font-style="italic" text-case="title" variable="container-title"/>
  </macro>
  ...
  <macro name="source-monographic-description-note">
    <choose>
      <if match="any" type="event paper-conference performance speech">
        <!-- Conference presentations should describe the session unless published in a proceedings -->
        <choose>
  ...
  <macro name="source-locator-subsequent-monographic">
    <group delimiter=", ">
      <choose>
        ...
        <else-if is-numeric="volume" locator="page" variable="part-number">
          <text macro="label-volume"/>
          <text macro="label-part-number"/>
          <text macro="label-locator"/>
        </else-if>
  ...
  <macro name="bibliography-filtered-notes">
    <choose>
      ...
      <else-if match="any" type="document manuscript paper-conference speech">
        <!-- In note styles, the bibliography also omits inaccessible manuscripts (CMOS18 14.114), conference papers (CMOS18 14.115), and private documents (CMOS18 14.118) -->
        <choose>
          <if match="any" variable="archive archive-place container-title DOI number publisher references URL">
            <text macro="bibliography-notes"/>
          </if>
