...
const getVariants = prefix => {
	return [
		...
		`${prefix}/tags/:tags/search/:search/:qmode/items/:items(${multipleIdRe})/attachment/:attachment/:view(library|collection|item-list|item-details)?`,
		...
		`${prefix}/tags/:tags/items/:items(${multipleIdRe})/attachment/:attachment/:view(library|collection|item-list|item-details)?`,
		...
		`${prefix}/search/:search/:qmode/items/:items(${multipleIdRe})/attachment/:attachment/:view(library|collection|item-list|item-details)?`,
		...
		`${prefix}/items/:items(${multipleIdRe})/attachment/:attachment/:view(library|collection|item-list|item-details)?`,
