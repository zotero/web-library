...
export const pdfReaderURL = '/static/web-library/reader/reader.html';
export const pdfReaderCMapsURL = '/static/web-library/reader/pdf/web/cmaps/';
export const pdfReaderStandardFontsURL = '/static/web-library/reader/pdf/web/standard_fonts/';
