 ...
 * Git Info SHA1: 8ad8d8303d1cede1b0da79eadb37eca5e63f9970 Date: Wed Aug 3 14:45:53 2011 -0700
			...
			$.ajax({
				...
				success: function( html ) {
					...
					page.one('pagecreate', function(){
						console.log("==================================PAGECREATE ONE CALLBACK");
...
$( document ).bind( "pagecreate", function( e ){
	console.log("=========================my own document pagecreate bind");
	console.log(e);
});
//auto self-init widgets
$( document ).bind( "pagecreate enhance", function( e ){
	console.log("======================pagecreate enhance anonymous page");
...
$.widget( "mobile.dialog", $.mobile.widget, {
	...
	refresh: function() {
		...
		if(!$el.find( ":jqmData(role='header') :jqmData(rel='back')" ).length ){
			console.log('no rel=back button yet - adding one');
			$el.find( ":jqmData(role='header')" )
...
//auto self-init widgets
$( $.mobile.dialog.prototype.options.initSelector ).live( "pagecreate create", function(){
	$( this ).dialog();
});
...
$( ":jqmData(role='page'), :jqmData(role='dialog')" ).live( "pagecreate recreate enhance", function( e ) {
	console.log("===============================page and dialog pagecreate anonymous function");
	var $page		= $( this ),
...
$.widget( "mobile.checkboxradio", $.mobile.widget, {
	...
	_create: function() {
		console.log("===================mobile.checkboxradio create");
		var self = this,
			input = this.element,
