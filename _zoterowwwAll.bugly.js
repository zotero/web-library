...
var Zotero = {
    ...
    config: {
        ...
        baseWebsiteUrl: "http://localhost/www-library/library.php",
...
Zotero.ajax.apiQueryString = function(passedParams, useConfigKey) {
    ...
    var queryParamOptions = [ "start", "limit", "order", "sort", "content", "format", "q", "fq", "itemType", "itemKey", "locale", "tag", "tagType", "key", "style", "linkMode", "linkwrap" ];
    var queryParams = {};
...
Zotero.ajax.proxyWrapper = function(requestUrl, method) {
    if (Zotero.config.proxy) {
        ...
        return Zotero.pages.baseURL + "/proxyRequest.php?requestMethod=" + method + "&requestUrl=" + encodeURIComponent(requestUrl);
    } else {
        return requestUrl;
    }
};
    ...
    base: {
        init: function() {
            ...
            if (typeof Zotero != "undefined" && !Zotero.config.librarySettings.mobile || typeof Zotero == "undefined") {
                Z.debug("tagline and search setup");
                this.tagline();
                this.setupSearch();
                this.setupNav();
                J("#sitenav .toggle").click(this.navMenu);
            }
            Z.debug("support setup");
...
Zotero.ui.showSpinner = function(el, type) {
    if (!type) {
        J(el).html("<img class='spinner' src='/www-library/static/images/theme/broken-circle-spinner.gif'/>");
...
Zotero.ui.appendSpinner = function(el) {
    J(el).append("<img class='spinner' src='/www-library/static/images/theme/broken-circle-spinner.gif'/>");
};
