...
<html lang="en" class="no-js"> 
    <head> 
        ...
        <!-- css -->
        <link rel="stylesheet" href="<?=$staticPath?>/css/theme_style2.css" 
            type="text/css" media="screen" charset="utf-8"/>
        <link rel="stylesheet" href="<?=$staticPath?>/css/library_style2.css" 
            type="text/css" media="screen" charset="utf-8"/>
...
<div id="library">
    ...
    <div class="single-col" id="library-panel">
...
<?include 'jquerytemplates/exportformats.jqt';?>
        ...
        <footer>
            <div class="center container">
                <p>Powered by <a href="http://www.zotero.org">Zotero</a></p>
        ...
        <script type="text/javascript" charset="utf-8">
            J("#left-drawer").css("height", J(window).height() - 65);
            J(window).resize(function(){
                J("#left-drawer").css("height", J(window).height() - 65);
            });
            
            J(".item-pane-flex-container").css("height", J(window).height() - 120);
            J(window).resize(function(){
                J(".item-pane-flex-container").css("height", J(window).height() - 120);
            });
            /*
            J("#library-items-div").css("height", J(window).height() - 120);
            J(window).resize(function(){
                J("#library-items-div").css("height", J(window).height() - 120);
            });
            J("#item-details-div").css("height", J(window).height() - 120);
            J(window).resize(function(){
                J("#item-details-div").css("height", J(window).height() - 120);
            });
            */
        ...
        <script type="text/javascript" charset="utf-8">
            ...
            Zotero.config = <?include "zoteroconfig2.js";?>
        </script>
