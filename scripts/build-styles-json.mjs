...
const stylesCacheTime = process.env.STYLES_CACHE_TIME ?? 86400000; // ms
...
try {
	...
	const stat = await fs.stat(stylesJsonPath);
...
const output = { coreCitationStyles, citationStylesCount };
